...
import ArticleDetils from './components/detils';
import CateList from './components/cateList';
import CateDetils from './components/cateDetils';
const { confirm } = Modal;
...
class NewsList extends React.Component {
  ...
  render() {
    ...
    const { createVisible, editForm, isAdd, cateVisible, editCate, cateListVisible } = this.state;
    return (
      <PageHeaderWrapper>
