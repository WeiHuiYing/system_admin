  ...
  <div class="content-main">
    ...
    >
      ...
      <div style="text-align: center">
        ...
        <Button style="margin-left: 20px" type="primary" @click="changeSeller()"
          >保存</Button
        >
      </div>
    </Modal>
...
<script>
import { asinList, uploadAsin, batchUpdateAsin } from "@/api/ResManage";
export default {
  data() {
    return {
      uploadLoading: false,
  ...
  methods: {
    ...
    changeSeller() {
      const _this = this;
      this.$refs["asinForms"].validate((valid) => {
        if (valid) {
          batchUpdateAsin(_this.rowInfo).then((res) => {
            _this.modelDetils = false;
