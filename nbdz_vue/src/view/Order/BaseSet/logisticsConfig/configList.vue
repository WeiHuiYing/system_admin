<template>
  <div class="content-main">
    ...
    <Modal
      ...
      footer-hide
    >
      <Form ref="formDetils" label-position="right" :label-width="120">
        <FormItem prop="name" label="预留参数">
          <Input v-model="editRow.name" placeholder="请输入预留参数"></Input>
        </FormItem>
...
<script>
import { configLogistics as getList } from "@/api/order";
