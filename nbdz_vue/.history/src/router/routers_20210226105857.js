        ...
        children: [
          ...
          },
          {
            ...
            meta: {
              title: "联邦订单9610",
              access: [
                "report_client_public_customsdeclaration:fedex_order9610"
              ]
            },
            component: () =>
              import("@/view/Common/Declare/FedexOrder9610/List.vue")
          }
        ]
      },
      {
    ...
    children: [
      {
        ...
        children: [
          ...
          },
          {
            ...
            component: () =>
              import("@/view/Finance/BaseSet/StandardPrice/List.vue")
          }
        ]
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            meta: {
              title: "paypal交易信息",
              access: ["report_client_financedepartment_sale:paypal_deal"]
            },
            component: () =>
          ...
          },
          {
            ...
            component: () => import("@/view/Finance/Sales/TOP5Total/List.vue")
          },
          {
            path: "AmazonTransInfo",
            name: "AmazonTransInfo",
            meta: {
              title: "亚马逊销售明细",
              access: ["report_client_financedepartment_sale:paypal_deal"]
            },
            component: () =>
              import("@/view/Finance/Sales/AmazonTransInfo/List.vue")
          }
        ]
      },
      {
