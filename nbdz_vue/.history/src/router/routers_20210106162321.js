  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: {
          title: "期间成本",
          access: ["report_sale:period_cost"]
        },
        component: () => import("@/view/Analysis/PeriodCost/List.vue")
      },
      {
        path: "PeriodSkuCost",
        name: "PeriodSkuCost",
        meta: {
          title: "期间sku成本",
          access: ["report_sale:sku_period_cost"]
        },
        component: () => import("@/view/Analysis/PeriodSkuCost/List.vue")
      },
      {
        path: "ProductCost",
        name: "ProductCost",
        meta: {
          title: "产品成本列表",
          access: ["report_sale:costlist"]
        },
        component: () => import("@/view/Analysis/ProductCost/List.vue")
      }
    ]
  },
  {
