      ...
      <Row>
        ...
        <Col span="12">
          <FormItem prop="storename" label="店铺">
            <Select
              :disabled="!Row.plateform || Row.plateform == '' ? true : false"
...
<script>
import { editShop, addShop } from "@/api/ResManage";
import { GetShop } from "@/api/order";
