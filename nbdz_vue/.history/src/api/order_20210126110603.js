...
// 逾期未出货报表
export const getProductExpiryList = data => {
  return axios.request({
    url: "/newApi/order/getProductExpiryList",
    method: "POST",
    data
  });
};
export const exportProductExpiryList = data => {
  return axios.request({
    url: "/newApi/order/exportProductExpiryList",
    method: "POST",
    data,
    responseType: "blob"
  });
};
export const importProductionSku = data => {
  return axios.request({
    url: "/newApi/order/importProductionSku",
    method: "POST",
    data
  });
};
