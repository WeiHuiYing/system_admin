...
export default {
  ...
  methods: {
    loadData() {
      ...
      console.log(filterLoandate && filterShipping && filterPaid);
      if (!filterLoandate && filterShipping && filterPaid) {
        console.log("000");
      } else {
        console.log("111");
      }
      // if (filterLoandate && filterLoandate === false) {
      //   return false;
      // }
      // if (filterLoandate.length > 0) {
      //   filterQuery = filterQuery.concat(filterLoandate);
      // }
      // if (filterShipping && filterShipping === false) {
      //   filterQuery = false;
      // }
      ...
      // }
      // if (filterPaid && filterPaid === false) {
      //   filterQuery = false;
      // }
      // console.log(filterQuery);
