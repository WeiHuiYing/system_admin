...
export default {
  ...
  methods: {
    ...
    filtersObj() {
      ...
      console.log(filterLoandate == false);
      if (filterLoandate == false) {
        console.log(filterLoandate);
        return false;
      } else if (filterLoandate.length > 0) {
      ...
      if (filterShipping == false) {
        return false;
      } else if (filterShipping.length > 0) {
