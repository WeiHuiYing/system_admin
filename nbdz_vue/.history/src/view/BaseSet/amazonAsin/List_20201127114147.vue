  ...
  <div class="content-main">
          ...
          >
            ...
            <FormItem>
              <Button
                ...
                >搜索</Button
              >
              <Button @click="changeSeller()" type="primary"
                >修改销售人员</Button
              >
            </FormItem>
          </Form>
    ...
    >
      <Form
        ...
        :label-width="100"
      >
        <FormItem label="老销售人员" prop="oldPersonSeller">
          <Input
            v-model="rowInfo.oldPersonSeller"
            placeholder="请输入老销售人员"
          ></Input>
        </FormItem>
        <FormItem label="新销售人员" prop="newPersonSeller">
          <Input
...
export default {
  data() {
    return {
      ...
      asinRules: {
        oldPersonSeller: [
          { required: true, message: "请输入老的销售人员", trigger: "blur" },
        ],
        newPersonSeller: [
          { required: true, message: "请输入新的销售人员", trigger: "blur" },
        ],
      },
    };
  },
