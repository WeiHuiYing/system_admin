    ...
    <div style="margin: 10px 0" class="search-con search-con-top">
      <Row>
        ...
        <Col :span="2">
          <Upload
            :action="
              'http://192.168.1.18:8817/api/OrderReport/importOrderTurnoverRate?yearMonth=' +
              upData.yearMonth
            "
            name="excelFile"
            :headers="upHeaders"
...
export default {
  ...
  methods: {
    ...
    handleBefore() {
      let _this = this;
      if (_this.filters.yearMonth && _this.filters.yearMonth != "") {
        _this.upData.yearMonth = dayjs(_this.filters.yearMonth).format(
          "YYYY-MM"
        );
        console.log(_this.upData.yearMonth);
        return false;
