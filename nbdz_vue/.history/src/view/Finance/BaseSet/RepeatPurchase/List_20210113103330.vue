  ...
  <div class="content-main">
    <div class="search-con search-con-top">
      <Row>
        ...
        <Col :span="2">
          <Button @click="exprotData()" type="primary">导出</Button>
        </Col>
      </Row>
    </div>
    <Table
...
<script>
import { GetRepeatCustList as getList, ExportRepeatCust } from "@/api/finance";
import { GetShop, GetPlateform as getPlateform } from "@/api/public";
