      ...
      <Row>
        <Col :span="22">
          <Form ref="formInline" label-position="right" :label-width="80" inline>
            ...
            <FormItem prop="store__name" label="店铺">
              <Input v-model="filters.store__name" placeholder="请输入店铺"></Input>
            </FormItem>
            <FormItem prop="asin" label="编号">
              <Input v-model="filters.asin" placeholder="请输入唯一编号"></Input>
            </FormItem>
            <FormItem>
...
<script>
import { amazonInventory as getList ,exportAmazonInventory as exportList} from "@/api/Analysis";
