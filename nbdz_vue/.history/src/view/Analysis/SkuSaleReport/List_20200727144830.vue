      ...
      <Row>
        <Col :span="22">
          <Form ref="formInline" label-position="right" :label-width="80" inline>
            ...
            <FormItem label="参考单号">
              <Input class="search-input" clearable v-model="filters.RefNo" />
            </FormItem>
            <FormItem label="发货仓库">
      ...
      <Form ref="formInline" label-position="right" :label-width="150" inline>
        ...
        <FormItem prop="OrderType" label="订单类型">
          <Select v-model="filters.OrderType" clearable style="width:150px">
            <Option label="正常销售订单" value="正常销售订单">正常销售订单</Option>
            <Option label="重发订单" value="重发订单">重发订单</Option>
            <Option label="营销单" value="营销单">营销单</Option>
            <Option label="线下单分" value="线下单分">线下单分</Option>
          </Select>
        </FormItem>
