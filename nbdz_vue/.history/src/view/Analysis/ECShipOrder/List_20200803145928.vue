  ...
  <div class="content-main">
    <Row class="search-con search-con-top">
      <Col :span="22">
        <Form ref="formInline" label-position="right" :label-width="90" inline>
          <FormItem label="子SKU">
            <Input style="width:120px" placeholder="请输入搜索子SKU" clearable v-model="filters.itemSku" />
          </FormItem>
          <FormItem label="订单号">
            <Input
              style="width:120px"
    ...
    >
      <Form ref="formInline" label-position="right" :label-width="100" inline>
        <FormItem label="子SKU">
          <Input placeholder="请输入搜索子SKU" clearable v-model="filters.itemSku" />
        </FormItem>
        <FormItem label="订单号">
        ...
        <FormItem label="备注">
          <Input placeholder="请输入搜索备注" clearable v-model="filters.remark" />
        </FormItem>
        <FormItem label="发货仓">
