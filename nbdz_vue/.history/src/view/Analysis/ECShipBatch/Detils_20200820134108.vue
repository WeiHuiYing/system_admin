<template>
  <div>
    <Tabs>
      ...
      <TabPane label="装箱单信息">
        <Table ref="tables" :data="rowInfo.Packing" v-bind:columns="packingColums" stripe></Table>
      </TabPane>
      <TabPane label="订单产品信息">
        <Table ref="tables" :data="rowInfo.products" v-bind:columns="productColums" stripe></Table>
      </TabPane>
    </Tabs>
  </div>
</template>
