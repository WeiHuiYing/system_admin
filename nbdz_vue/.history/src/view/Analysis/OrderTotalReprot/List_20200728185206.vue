  ...
  <div class="content-main">
    ...
    >
      <Form ref="formInline" label-position="right" :label-width="150" inline>
        ...
        <FormItem label="订单来源">
          <Input clearable v-model="filters.OrderSource" />
        </FormItem>
...
export default {
  ...
  methods: {
    ...
    filtersObj() {
      ...
      if (_this.filters.OrderSource && _this.filters.OrderSource != "") {
        let OrderSourceObj = {
          key: "OrderSource",
          binaryop: "like",
          value: _this.filters.OrderSource,
          andorop: "and",
        };
        filterQuery.push(OrderSourceObj);
      }
