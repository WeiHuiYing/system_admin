      ...
      <Row>
        <Col :span="24">
          ...
          >
            ...
            <FormItem prop="state" label="洲">
              <Input
                v-model="filters.state"
                style="width: 200px"
                placeholder="请输入要搜索的洲"
                clearable
              ></Input>
            </FormItem>
            <FormItem>
...
<script>
import { LogisticsEfficiency as getList } from "@/api/common";
...
export default {
  ...
  methods: {
    loadData() {
      let _this = this;
      if (_this.filters.send_time && _this.filters.send_time != "") {
        let data = {
