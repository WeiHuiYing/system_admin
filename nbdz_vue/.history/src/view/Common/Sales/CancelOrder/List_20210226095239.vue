      ...
      <Row>
        <Col :span="24">
          ...
          >
            ...
            <FormItem prop="FkStart" label="系统创建开始时间">
              <DatePicker
            ...
            <FormItem prop="FkEnd" label="系统创建结束时间">
              <DatePicker
...
export default {
  ...
  methods: {
    loadData() {
      ...
      if (_this.filters.FkStart == "") {
        _this.filters.FkStart = dayjs().subtract(7, "day").format("YYYY-MM-DD");
      }
      if (_this.filters.FkEnd == "") {
