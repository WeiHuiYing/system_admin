...
<script>
import { order as getList, exportExcel as exportList } from "@/api/Logistics";
  ...
  methods: {
    loadData() {
      ...
      const data = {
        ...
        paid_data_gte: dayjs(_this.filters.startTime).format("YYYY-MM-DD "),
        paid_data_lte: dayjs(_this.filters.endTime).format("YYYY-MM-DD ")
      };
      getList(data)
        .then(res => {
